const monthNames = [
  ...
  function showModal(day, month, year) {
    ...
    document.getElementById("eventDate").value = `${day} de ${monthNames[month]} ${year}`;
  ...
  function toggleAllDay() {
    ...
    document.getElementById("startTime").disabled = isChecked;
    document.getElementById("endTime").disabled = isChecked;
  }
